...
class MRNet(nn.Module):
    ...
    def forward(self, x):
        ...
        if self.useMultiHead:
            ...
            positions = torch.tensor(range(x.size(0))) 
...
class Attention(nn.Module):
    def __init__(self, num_sublayers, num_heads, hidden_dim, dim_feedforward, dim_kq=None, dim_v=None):
        ...
        self.layers = [MultiheadedAttentionSubLayer(num_heads, hidden_dim, dim_feedforward, dim_kq, dim_v) for i in range(num_sublayers)]
